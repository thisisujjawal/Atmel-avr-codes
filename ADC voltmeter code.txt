 ...
 int main(void)
 {
	 ...
	 unsigned int ADCvalue = 0; //Variable to hold ADC Result (in this ,for binary code of adc value will come and after storing in this variable it will converted into integer type)
	 ...
	 char y[7];		//Array to hold voltage value in string form.
	 ...
	 while (1)
	 {
		 ...
		 */
		 ...
		 //itoa function takes 3 arguments 1. integer value or variable  2. array name   3. integer base i.e if 10 it will convert integer into decimal and then store it in the array...2 for binary.....16 for hex etc.
		 itoa(ADCvalue , x ,10 );
		 
		 //dtostrf is the function to convert double or float into string 
		 //dtostrf function takes 4 arguments  1. float value or variable   2. how many numbers are there after decimal point in float value   3. how many numbers you want after deciaml point in string variable    4. string variable name
		 float voltage = (ADCvalue*0.004887);   //Basically step size=5/1023=0.004887 V = 4.887 mV
		 dtostrf(voltage,5,2,y);
		 ...
		 lcd_cmd(0xc6);   
		 lcd_string(y);
		 _delay_ms(1000); //we are giving delay because if not given then nothing will be printed on LCD because of the clear screen command  given in the while loop
	 }
 }
